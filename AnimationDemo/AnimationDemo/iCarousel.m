...
- (CGFloat)alphaForItemWithOffset:(CGFloat)offset
{
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeHomeCell:
        case iCarouselTypeSearchCell:
...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeHomeCell:
        {
            ...
            const CGFloat centerScale = 6.0f;
            //the larger the xFactor, the smaller the magnified area
            const CGFloat xFactor = 0.9f;
            //should the gap also be scaled? or keep it constant.
            const BOOL scaleGap = YES;
            
            const CGFloat spacing = [self carousel:self valueForOption:iCarouselOptionSpacing withDefault:1.045];
            const CGFloat gap = scaleGap?0.00:spacing-1.0;
            ...
            CGFloat scale = [self scaleForX:offset xFactor:xFactor-.11 centerScale:centerScale];
            transform = CATransform3DTranslate(transform, scaleOffset*self.itemWidth, 0.0, 0.0);
        ...
        case iCarouselTypeSearchCell:
        {
            ...
            //the larger the xFactor, the smaller the magnified area
            const CGFloat xFactor = 0.8f;
            //should the gap also be scaled? or keep it constant.
            const BOOL scaleGap = YES;
            
            const CGFloat spacing = [self carousel:self valueForOption:iCarouselOptionSpacing withDefault:1.045];
            const CGFloat gap = scaleGap?0.01:spacing-1.0;
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.1];
...
- (NSInteger)circularCarouselItemCount
{
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedWheel:
        {
            ...
            count = MIN(MAX_VISIBLE_ITEMS, MAX(0, ceil(width / (spacing * _itemWidth)) * M_PI));
...
- (void)layOutItemViews
{
    ...
    switch (_type)
    {
        ...
        {
//            _wrapEnabled = YES;
            _wrapEnabled = NO; // changed by ruchika
